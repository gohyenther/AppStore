...
CREATE TABLE IF NOT EXISTS offices(
 ...
 features VARCHAR(512) REFERENCES office_features(features) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS workcubes(
 unit VARCHAR(32) REFERENCES units(purpose) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 features VARCHAR(512) REFERENCES workcube_features(features) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 timescale VARCHAR(32) NOT NULL,
 type VARCHAR(32) REFERENCES type(classification) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 size_sf NUMERIC(16) NOT NULL,
 street VARCHAR(32),
...
CREATE TABLE IF NOT EXISTS confrooms(
 unit VARCHAR(32) REFERENCES units(purpose) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 features VARCHAR(512) REFERENCES confroom_features(features) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 timescale VARCHAR(32) NOT NULL,
 type VARCHAR(32) REFERENCES type(classification) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 size_sf NUMERIC(16) NOT NULL,
 street VARCHAR(32),
...
CREATE TABLE IF NOT EXISTS storages(
 unit VARCHAR(32) REFERENCES units(purpose) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 features VARCHAR(512) REFERENCES storage_features(features) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 timescale VARCHAR(32) NOT NULL,
 type VARCHAR(32) REFERENCES type(classification) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
 size_sf NUMERIC(16) NOT NULL,
 street VARCHAR(32),
